class GalleryController < ApplicationController
  ...
  def search
    ...
    @search_results= Store.find_by_sql ["Select * from stores WHERE name like ? or flower_type like ? or color like ? or description like ?",keyword,keyword,keyword,keyword]
  end
end
